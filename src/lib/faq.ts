...
export const faqs = [
  ...
  },
  {
    ...
    answer:
      "Personlig træning: book en tid, eller send en forespørgsel på 5 træninger. Online Coaching: send en forespørgsel via booking — du vælger ikke tid i gymmet, og opstart aftales.",
  },
  {
