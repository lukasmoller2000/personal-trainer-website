...
export const siteConfig = {
  ...
  description:
    "Personlig træner i Viborg. 1:1 PT i Viborg Fitness Gym til 300 kr. (VFG-medlem: 250 kr.), eller online coaching til 799 kr./md. Styrke, fedttab og en hverdag der holder.",
  location: "Viborg",
  postalCode: "8800",
